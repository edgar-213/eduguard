...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2025 a las 15:16:08
...
(1, 'Matemáticas', 'Prof. González', 'blue', NULL),
(2, 'Historia', 'Prof. García', 'purple', NULL),
(3, 'Física', 'Prof. Torres', 'green', NULL),
(4, 'Química', 'Prof. Mendoza', 'orange', NULL),
...
ALTER TABLE `notas`
  ...
  ADD CONSTRAINT `notas_ibfk_2` FOREIGN KEY (`materia_id`) REFERENCES `materias` (`id`) ON DELETE CASCaADE;
